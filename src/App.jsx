...
const PROJECTS=[
  ...
  // ── RAG Bot — exception: fixed at position 3 ────────────────────────────
  ...
  // ── Backend (continued) ───────────────────────────────────────────────────
  {num:"04",name:"Gamezo Discord Bot",tagline:"Heavy backend bot · multi-game economy · live stock market",category:"Backend",highlights:["Backend: SQLite3 persistence, async scheduling, REST integrations","Games: Coin flip, rock-paper-scissors, airplane crash, rollover bet","Economy: live stock market via REST API, hourly rewards, portfolio system","Leaderboard, tip system, win/loss stats, cooldown rate limiting","Deployed as a persistent worker via Procfile (Heroku/Render)"],tech:["Python","Discord.py","SQLite3","asyncio","REST API","Stocks"]},
  {num:"05",name:"Todo App",tagline:"Android task manager · SQLite persistence · RecyclerView",categories:["Backend","Android"],highlights:["SQLite CRUD via custom DatabaseHelper","RecyclerView + TaskAdapter with live check/delete","Instant UI updates without full list refresh","View Binding · minSdk 21 · targetSdk 36"],tech:["Kotlin","Android","SQLite","RecyclerView","View Binding","Gradle"]},

  // ── AI / ML ───────────────────────────────────────────────────────────────
  {num:"06",name:"Cricket Score Predictor",tagline:"Live IPL · T20 · ODI score prediction via XGBoost",category:"AI/ML",highlights:["3 XGBoost models: IPL, T20, ODI","CricAPI live integration","Streamlit UI with instant predictions","Format-specific feature engineering"],tech:["Python","Streamlit","XGBoost","Scikit-learn","Pandas","CricAPI","Pickle"]},
  {num:"07",name:"IPL Win Predictor",tagline:"Real-time IPL win probability via ML",category:"AI/ML",highlights:["Logistic Regression + Random Forest","Dynamic win % via CRR/RRR/wickets","Feature engineering on 4500+ rows","Streamlit in-match probability viz"],tech:["Python","Streamlit","Scikit-learn","Pandas","NumPy","Matplotlib"]},
  {num:"08",name:"Book Recommender System",tagline:"Dual-mode: popularity + collaborative filtering",category:"AI/ML",highlights:["Popularity: top 50 filtered by 250+ ratings","Cosine similarity on pivot matrix","Filter: users with 200+ ratings","Streamlit UI with covers + ratings"],tech:["Python","Streamlit","Scikit-learn","Pandas","NumPy","Cosine Similarity"]},
  {num:"09",name:"WhatsApp Chat Analyser",tagline:"Upload export · visualize conversation trends",category:"AI/ML",highlights:["Timeline analysis · daily/weekly/monthly","Top emoji breakdown pie charts","Most active user leaderboard","WordCloud + Matplotlib charts"],tech:["Python","Streamlit","Pandas","Matplotlib","WordCloud","Regex","Emoji"]},
  ...
  {num:"12",name:"SalesForce UI Clone",tagline:"Pixel-accurate Salesforce homepage clone",category:"Frontend",highlights:["Full layout: nav, hero, content strips","CSS-only responsive grid","Brand-faithful typography + spacing","Pure HTML/CSS — no frameworks"],tech:["HTML","CSS","Flexbox","Responsive Design"]},
];
